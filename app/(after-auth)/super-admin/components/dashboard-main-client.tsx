...
import { Island, Region } from "@/db/schemas/auth";
import { cn } from "@/lib/utils";

import { getIslandsByRegion } from "../actions/dashboard-filters";

interface DashboardMainClientProps {
  regions: Region[];
}

const DashboardMainClient = ({ regions }: DashboardMainClientProps) => {
